...
upstream_status_nonliteral_valid_status = [
    "Pending",
    "Accepted",
    "Backport",
    "Denied",
...
upstream_status_inappropriate_info = (
    common.start + upstream_status_mark + common.colon + common.inappropriateinfo
)
upstream_status_submitted_info = (
    common.start + upstream_status_mark + common.colon + common.submittedinfo
)
